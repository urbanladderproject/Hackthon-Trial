...
public class Giftcard_with_empty_sender_email extends utils.ExtentReport {
	...
	public void afterMethod(ITestResult result) throws Exception {
		...
		if (result.isSuccess())
			excel.reportToExcel("Empty Sender Email accepting Test: SUCCESS");
		else
			excel.reportToExcel("Empty Sender Email accepting Test: FAILURE");
	}

	@AfterClass
	public void closeBrowser() throws IOException {
		excel.reportToExcel("Empty Sender Email accepting Test: ENDED");
		// close the driver
