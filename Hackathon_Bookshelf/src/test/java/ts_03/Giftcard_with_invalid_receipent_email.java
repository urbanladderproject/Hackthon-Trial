...
public class Giftcard_with_invalid_receipent_email extends utils.ExtentReport {
	...
	public void invalid_email() throws Exception {
		...
		Screenshots.takesnap(driver, "Invalid recepient email",browsertype);
	...
	public void afterMethod(ITestResult result) throws Exception {
		...
		if (result.isSuccess())
			excel.reportToExcel("Invalid recepient email rejecting Test: SUCCESS",browsertype);
		else
			excel.reportToExcel("Invalid recepient email rejecting Test: FAILURE",browsertype);
	}
