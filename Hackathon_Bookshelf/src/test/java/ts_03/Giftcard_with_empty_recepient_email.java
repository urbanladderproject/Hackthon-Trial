...
public class Giftcard_with_empty_recepient_email  extends utils.ExtentReport {
	...
	public void empty_email() throws Exception {
		...
		String warning = gc.Alerts();Assert.assertTrue(warning.contains("fill out this field"));
	...
	public void afterMethod(ITestResult result) throws Exception {
		...
		if (result.isSuccess())
			excel.reportToExcel("Invalid recepient email accepting Test: SUCCESS");
		else
			excel.reportToExcel("Invalid recepient email accepting Test: FAILURE");
	}
